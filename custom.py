...
constructor: a function taking the blank surface for input and draws on
the surface. If the function does not return None, the return value is
considered to be the surface. If the function returns None,
